...
namespace Eventos.Info.UI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private EventosdbEntities1 db1 = new EventosdbEntities1();
        //
        // GET: /Account/Login
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    organizador.OrganizadorId = userId;
                    organizador.Usuario = model.UserName;
                    organizador.Password = model.Password;
                  
                    db1.Organizador.Add(organizador);
                    db1.SaveChanges();                             

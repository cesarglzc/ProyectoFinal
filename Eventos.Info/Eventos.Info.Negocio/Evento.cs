...
namespace Eventos.Info.Negocio
{
    public class Evento
    {
     ...
     //   private EventosdbEntities db = new EventosdbEntities();
        ...
        public List<Negocio.Evento> LeerUltimosEventos()
        {
            ...
            try
            {
                List<Eventos.Info.DAL.Evento> listaDAL = CommonBC.ModeloEvento.Evento.OrderByDescending(res => res.EventoId).OrderByDescending(x=>x.EventoId).ToList();
